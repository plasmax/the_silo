...
outliner_panel = nukescripts.panels.registerWidgetAsPanel('the_silo.scripts.minibrowser.nuke_browserwidget', 'Nuke Mini Browser', 'uk.co.max.nuke_browserwidget', True )
nuke.menu('Nodes').addCommand('Scripts/Nuke Mini Browser', 'the_silo.scripts.minibrowser.load_browserwidget()','shift+b')
nuke.menu('Nodes').addCommand('Scripts/Nuke Mini Browser Panel', 'the_silo.scripts.minibrowser.make_minibrowser()','shift+alt+b')
